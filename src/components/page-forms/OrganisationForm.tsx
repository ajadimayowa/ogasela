...
export interface ILogin {
    ...
    address: string;
    description: string;
    createdBy: string; // This should be the ID of the creator, e.g., root admin or super admin
...
const OrganisationForm = () => {
    ...
    const handleSubmit = async (payload: ILogin) => {
        ...
        try {
            const res = await api.post('/org/create', payloadData);
            // navigate('/root-login');
            ...
            >
                {
                    ({ handleSubmit, handleChange, values, setFieldValue }) => (<Form className='d-flex align-items-center flex-column gap-3 w-100 p-3' onSubmit={handleSubmit}>
                        <>
                            <p className='fw-bold w-100 text-start'>| Organization Registration</p>
                                ...
                                <div className='w-100 d-flex flex-column align-items-center gap-2'>
                                    ...
                                    <div className='w-100'>
                                        <ReusableInputs
                                            ...
                                            required
                                        />
                                        <ErrorMessage name="regNumber" component="div" className="text-danger" />
                                    </div>
