...
const  MemberFormStep3 = ({ setFieldValue, values }: any) => {
    ...
    return (
        <>
            <p className="fw-bold p-0 m-0">1st Gurantor Information</p>
                        ...
                        <tr>
                            <td className=''>
                                <div className='w-100'>
                                    <MultiPartFormReusableDropDownSelect
                                        ...
                                        options={titles}
                                    />
                                    {/* <ErrorMessage name="g1Title" component="div" className="text-danger" /> */}
                                </div>
                            </td>
                            ...
                            <td className=''>
                                <div className='w-100'>
                                    <ReusableInputs
                                        ...
                                        required
                                    />
                                    <ErrorMessage name="g1FullName" component="div" className="text-danger" />
                                </div>
                            </td>
                            ...
                            <td className=''>
                                <div className='w-100'>
                                    <ReusableInputs
                                        ...
                                        required
                                    />
                                    <ErrorMessage name="g1PhoneNumber" component="div" className="text-danger" />
                                </div>
                            </td>
                            ...
                            <td className=''>
                                <div className='w-100'>
                                    ...
                                    />
                                    <ErrorMessage name='stateOfg1' component="div" className="text-danger" />
                                </div>
                            </td>
                        </tr>
                                ...
                                <div className='w-100'>
                                    <div style={{ minWidth: '100px', maxWidth: '150px' }}>
                                        <div>
                                            ...
                                            <label htmlFor="g1Passport" className={`p-2 py-3 w-100 text-center text-primary border-1 m-0 fileUploadLabel`}>
                                                {<i className="bi bi-image-fill"></i>}
                                                {/* {fileName == '' ? ' Click to upload file' : ' Click to Replace File'} */}
                                                {values.g1Passport && (
                                                    <div className="mt-2 text-success">
                                                     {cutString(values.g1Passport.name, 10)}
                                                    </div>
                                                )}
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => handleFileChange(e, "g1Passport", setFieldValue)}
                                    ...
                                    <ErrorMessage name="g1Passport" component="div" className="text-danger" />
                                </div>
                            </td>
                                ...
                                <div className='w-100'>
                                    <div style={{ minWidth: '100px', maxWidth: '150px' }}>
                                        <div>
                                            ...
                                            <label htmlFor="g1ID" className={`p-2 py-3 w-100 text-center text-primary border-1 m-0 fileUploadLabel`}>
                                                {<i className="bi bi-image-fill"></i>}
                                                {/* {fileName == '' ? ' Click to upload file' : ' Click to Replace File'} */}
                                                {values.g1ID && (
                                                    <div className="mt-2 text-success">
                                                     {cutString(values.g1ID.name, 10)}
                                                    </div>
                                                )}
                                            ...
                                            <input
                                                ...
                                                type="file"
                                                className={`p-2 fileInput`}
                                                onChange={(e) => handleFileChange(e, "g1ID", setFieldValue)}
                                    ...
                                    <ErrorMessage name="g1ID" component="div" className="text-danger" />
                                </div>
                            </td>
                                ...
                                <div className='w-100'>
                                    <div style={{ minWidth: '100px', maxWidth: '150px' }}>
                                        <div>
                                            ...
                                            <label htmlFor="g1AttestationDocument" className={`p-2 py-3 w-100 text-center text-primary border-1 m-0 fileUploadLabel`}>
                                                {<i className="bi bi-file-earmark-pdf"></i>}
                                                {/* {fileName == '' ? ' Click to upload file' : ' Click to Replace File'} */}
                                                {values.g1AttestationDocument && (
                                                    <div className="mt-2 text-success">
                                                     {cutString(values.g1AttestationDocument.name, 15)}
                                                    </div>
                                                )}
                                            ...
                                            <input
                                                id="g1AttestationDocument"
                                                name="g1AttestationDocument"
                                                type="file"
                                                className={`p-2 fileInput`}
                                                onChange={(e) => handleFileChange(e, "g1AttestationDocument", setFieldValue)}
                                    ...
                                    <ErrorMessage name="g1AttestationDocument" component="div" className="text-danger" />
                                </div>
                            </td>
                        </tr>
