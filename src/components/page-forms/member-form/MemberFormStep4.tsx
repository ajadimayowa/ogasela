...
const  MemberFormStep4 = ({ setFieldValue, values }: any) => {
    ...
    return (
        <>
            <p className="fw-bold p-0 m-0">Gurantor 2 Information</p>
                        ...
                        <tr>
                            ...
                            <td className=''>
                                <div className='w-100'>
                                    <ReusableInputs
                                        ...
                                        required
                                    />
                                    <ErrorMessage name="g2FullName" component="div" className="text-danger" />
                                </div>
                            </td>
                            ...
                            <td className=''>
                                <div className='w-100'>
                                    <ReusableInputs
                                        ...
                                        required
                                    />
                                    <ErrorMessage name="g2PhoneNumber" component="div" className="text-danger" />
                                </div>
                            </td>
                            ...
                            <td className=''>
                                <div className='w-100'>
                                    ...
                                    />
                                    <ErrorMessage name='stateOfg2' component="div" className="text-danger" />
                                </div>
                            </td>
                        </tr>
                                ...
                                <div className='w-100'>
                                    <div style={{ minWidth: '100px', maxWidth: '150px' }}>
                                        <div>
                                            ...
                                            <label htmlFor="g2Passport" className={`p-2 py-3 w-100 text-center text-primary border-1 m-0 fileUploadLabel`}>
                                                {<i className="bi bi-image-fill"></i>}
                                                {/* {fileName == '' ? ' Click to upload file' : ' Click to Replace File'} */}
                                                {values.g2Passport && (
                                                    <div className="mt-2 text-success">
                                                     {cutString(values.g2Passport.name, 10)}
                                                    </div>
                                                )}
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => handleFileChange(e, "g2Passport", setFieldValue)}
                                    ...
                                    <ErrorMessage name="g2Passport" component="div" className="text-danger" />
                                </div>
                            </td>
                                ...
                                <div className='w-100'>
                                    <div style={{ minWidth: '100px', maxWidth: '150px' }}>
                                        <div>
                                            ...
                                            <label htmlFor="g2ID" className={`p-2 py-3 w-100 text-center text-primary border-1 m-0 fileUploadLabel`}>
                                                {<i className="bi bi-image-fill"></i>}
                                                {/* {fileName == '' ? ' Click to upload file' : ' Click to Replace File'} */}
                                                {values.g2ID && (
                                                    <div className="mt-2 text-success">
                                                     {cutString(values.g2ID.name, 10)}
                                                    </div>
                                                )}
                                            ...
                                            <input
                                                ...
                                                type="file"
                                                className={`p-2 fileInput`}
                                                onChange={(e) => handleFileChange(e, "g2ID", setFieldValue)}
                                    ...
                                    <ErrorMessage name="g2ID" component="div" className="text-danger" />
                                </div>
                            </td>
                                ...
                                <div className='w-100'>
                                    <div style={{ minWidth: '100px', maxWidth: '150px' }}>
                                        <div>
                                            ...
                                            <label htmlFor="g2AttestationDocument" className={`p-2 py-3 w-100 text-center text-primary border-1 m-0 fileUploadLabel`}>
                                                {<i className="bi bi-file-earmark-pdf"></i>}
                                                {/* {fileName == '' ? ' Click to upload file' : ' Click to Replace File'} */}
                                                {values.g2AttestationDocument && (
                                                    <div className="mt-2 text-success">
                                                       {cutString(values.g2AttestationDocument.name, 10)}
                                                    </div>
                                                )}
                                            ...
                                            <input
                                                id="g2AttestationDocument"
                                                name="g2AttestationDocument"
                                                type="file"
                                                className={`p-2 fileInput`}
                                                onChange={(e) => handleFileChange(e, "g2AttestationDocument", setFieldValue)}
                                    ...
                                    <ErrorMessage name="g2AttestationDocument" component="div" className="text-danger" />
                                </div>
                            </td>
                        </tr>
...
export default MemberFormStep4;