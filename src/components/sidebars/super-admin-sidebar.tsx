...
const SuperAdminSidebar: React.FC<any> = ({ isOpen, toggleSidbar }) => {
                        ...
                        .map((nav) => (
                            <li className="p-3" key={nav.id}>
                                ...
                                {nav.subPages && openMenus.includes(nav.id) && (
                                    <ul className="text-light ms-3 ">
                                        {nav.subPages.map((sub) => (
                                            <li className="p-3" key={sub.path}>
                                                <a href={sub.path} className="text-decoration-none text-light ">
                                                    {sub.title}
                                                </a>
                                            </li>
                                        ))}
