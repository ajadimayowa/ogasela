...
const RootAdminOrganizationListPage = () => {
    ...
    <div className="dashboard-container">
      <DecoratedCard>
        <div className='d-flex flex-wrap justify-content-between w-100'>
          <div>
            <h4 className="">Onboarded organizations.</h4>
            <p>See List of Organisation you have onboard.</p>
          </div>
        </div>
      </DecoratedCard>
      <div>
        <table className="table table-striped mt-3">
          <thead>
            <tr >
              <th scope="col" className='text-light' style={{backgroundColor:'#020C59'}}>S/N</th>
              <th scope="col" className='text-light' style={{backgroundColor:'#020C59'}}>Name</th>
              <th scope="col" className='text-light' style={{backgroundColor:'#020C59'}}>Reg Number</th>
              <th scope="col" className='text-light' style={{backgroundColor:'#020C59'}}>Date Created</th>
              <th scope="col" className='text-light' style={{backgroundColor:'#020C59'}}>Status</th>
            </tr>
          </thead>
          <tbody>
            {
...
export default RootAdminOrganizationListPage;