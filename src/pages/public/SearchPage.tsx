                ...
                <Button variant="outline fw-bold border mt-2" onClick={()=>navigate(-1)}>Go Back</Button>
                        ...
                        <Card className="p-4 shadow-sm border-0">
                            ...
                            <Row>
                                ...
                                <Col md={4}>
                                    <p>
                                        <strong role="button" className="p-2 rounded bg-info text-light" onClick={()=>setShowCont(!showCont)}>Show Contact:</strong> {showCont?'+234********':adInfo?.sellerName}
                                    </p>
                                </Col>
                                <Col md={4}>
                                    <p>
                                        <strong>Address:</strong> {showCont?'+234********':adInfo?.sellerName}
                                    </p>
                                </Col>
                            </Row>
                        </Card>
